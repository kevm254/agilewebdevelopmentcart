...
class UserStoriesTest < ActionDispatch::IntegrationTest
  ...
  # single line item corresponding to the product they
  # added to their cart.
  ...
  test "buying a product" do
    ...
    assert_response :success
    assert_template "new"
    post_via_redirect "orders", order: { name: "Dave Thomas", address: "123 The Drive", email: "dave@example.com", pay_type: "Check" }
    assert_response :success
    assert_template "index"
    cart = Cart.find(session[:cart_id])
